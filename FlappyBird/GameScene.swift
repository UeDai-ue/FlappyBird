...
//  FlappyBird
//
//  Created by 上江洲大輝 on 2020/03/25.
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func setupItem() {// 画像を読み込む
        ...
        let repeatScrollItem = SKAction.repeatForever(SKAction.sequence([itemAnimation, waitAnimation]))
        ...
        item.position = CGPoint(x: self.frame.size.width + itemTexture.size().width / 2, y: center_y)
    ...
    // MARK: - 衝突したときに呼ばれる SKPhysicsContactDelegateのメソッド。
